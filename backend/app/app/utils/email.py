...
email_config = ConnectionConfig(
    ...
    MAIL_STARTTLS=settings.MAIL_SMTP_TLS,  # Changed from MAIL_TLS to MAIL_STARTTLS
    MAIL_SSL_TLS=settings.MAIL_SMTP_SSL,  # Changed from MAIL_SSL to MAIL_SSL_TLS
    USE_CREDENTIALS=settings.MAIL_SMTP_USE_CREDENTIALS,
